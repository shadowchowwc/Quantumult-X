...
# > Scanner Pro
https://apps.apple.com/app/id333710667
# > 车票票
https://apps.apple.com/app/id6446212291

[rewrite_local]

# ～ RevenueCat@ddgksf2013
^https:\/\/api\.revenuecat\.com\/.+\/(receipts$|subscribers\/[^/]+$) url script-echo-response https://raw.githubusercontent.com/shadowchowwc/quantumult-x/main/premium/scanner-pro.js
...
if(ua.indexOf('ScannerPro') != -1) {obj['subscriber']['entitlements']['plus']=ddgksf2021;}
else if(ua.indexOf('%E8%BD%A6%E7%A5%A8%E7%A5%A8') != -1) {obj['subscriber']['entitlements']['vip+watch_vip']=ddgksf2021;}
else{
